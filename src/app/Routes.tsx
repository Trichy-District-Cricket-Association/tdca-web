...
const Routes = () => (
    <div>
        ...
        <ProtectedRoute exact path={PageRoutes.adminGrounds} userRole={UserRoles.admin} component={GroundAdd} />
        ...
        <ProtectedRoute exact path={PageRoutes.adminGroundAdd} userRole={UserRoles.admin} component={GroundAdd} />
    </div>
);
