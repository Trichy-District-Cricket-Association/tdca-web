        ...
        <div className="officeBearers">
            ...
            >
                <div className="officeBearer">
                    <div className="officeBearer__column1">
                        <img src={officeBearer1} alt="Dr R Ramasubbu" className="officeBearer__img" />
                    </div>
                    <div className="officeBearer__column2">
                        <h1 className="officeBearer__column2--name">Dr R Ramasubbu</h1>
                        <p className="officeBearer__column2--designation">President</p>
                        <p className="officeBearer__column2--contact">balajidmrtry@gmail.com</p>
                    </div>
                </div>
                <div className="officeBearer">
                    <div className="officeBearer__column1">
                    ...
                    <div className="officeBearer__column2">
                        <h1 className="officeBearer__column2--name">K Sanjay</h1>
                        <p className="officeBearer__column2--designation">Secretary</p>
                        <p className="officeBearer__column2--contact">sanjaykalidas@gmail.com</p>
                    </div>
                </div>
                ...
                <div className="officeBearer">
                    ...
                    <div className="officeBearer__column2">
                        <h1 className="officeBearer__column2--name">M Meenakshisundaram</h1>
                        <p className="officeBearer__column2--designation">Vice President</p>
                        <p className="officeBearer__column2--contact">kpr@anandengg.in</p>
                    </div>
                </div>
                ...
                <div className="officeBearer">
                    ...
                    <div className="officeBearer__column2">
                        <h1 className="officeBearer__column2--name">K Premanathan</h1>
                        <p className="officeBearer__column2--designation">Vice President</p>
                        <p className="officeBearer__column2--contact">kpr@anandengg.in</p>
                    </div>
                </div>
                ...
                <div className="officeBearer">
                    ...
                    <div className="officeBearer__column2">
                        <h1 className="officeBearer__column2--name">V Vasudevan</h1>
                        <p className="officeBearer__column2--designation">Vice President</p>
                        <p className="officeBearer__column2--contact">vasusangam@gmail.com</p>
                    </div>
                </div>
                <div className="officeBearer">
                    <div className="officeBearer__column1">
                    ...
                    <div className="officeBearer__column2">
                        <h1 className="officeBearer__column2--name">K Jayakarna</h1>
                        <p className="officeBearer__column2--designation">Vice President</p>
                        <p className="officeBearer__column2--contact">oxinakarna@yahoo.in</p>
                    </div>
                </div>
                ...
                <div className="officeBearer">
                    ...
                    <div className="officeBearer__column2">
                        <h1 className="officeBearer__column2--name">T Kumar</h1>
                        <p className="officeBearer__column2--designation">Jt Secretary</p>
                        <p className="officeBearer__column2--contact">majestic.cc@gmail.com</p>
                    </div>
                </div>
                ...
                <div className="officeBearer">
                    ...
                    <div className="officeBearer__column2">
                        <h1 className="officeBearer__column2--name">V Boobeshnathan</h1>
                        <p className="officeBearer__column2--designation">Jt Secretary</p>
                        <p className="officeBearer__column2--contact">boobeshnathan1981@gmail.com</p>
                    </div>
                </div>
                ...
                <div className="officeBearer">
                    ...
                    <div className="officeBearer__column2">
                        <h1 className="officeBearer__column2--name">M Sakthivel</h1>
                        <p className="officeBearer__column2--designation">Treasurer</p>
                        <p className="officeBearer__column2--contact">sakthivelmurugan0479@gmail.com</p>
                    </div>
                </div>
            </Carousel>
        </div>
